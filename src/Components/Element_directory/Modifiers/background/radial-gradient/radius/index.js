    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-radial-gradient-radius"
                            aria-current="page">radial-gradient-radius</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-radial-gradient-radius</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    ...
                    <ul>
                        ...
                        <li><a
                                href="en/concepts/divs/2/div-radial-gradient-relative-radius#div-radial-gradient-relative-radius">div-radial-gradient-relative-radius</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a
                                ...
                                <div class="dc-nav-toc-panel__control-name">radial-gradient-relative-center</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a
                                ...
                                <div class="dc-nav-toc-panel__control-name">radial-gradient-relative-radius</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
