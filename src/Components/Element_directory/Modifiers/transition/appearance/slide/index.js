...
const Component = () => {
    ...
    <div class="dc-doc-page__breadcrumbs">
        <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
            <ol class="dc-breadcrumbs__items">
                ...
                <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text">transition</span></li>
                <li class="dc-breadcrumbs__item"><a class="dc-breadcrumbs__text dc-breadcrumbs__text_link"
                        href="en/concepts/divs/2/div-appearance-transition">appearance-transition</a></li>
                <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                        href="en/concepts/divs/2/div-slide-transition" aria-current="page">slide-transition</span></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
            <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-slide-transition</span><button
            ...
            <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                <p>Slide animation.</p>
                <h2 id="parameters"><a href="en/concepts/divs/2/div-slide-transition#parameters" class="yfm-anchor"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <p>The value must always be <code>slide</code>.</p>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>A fixed value of an offset which the element starts appearing from or at which it
                                    finishes disappearing. If no value is specified, the distance to the selected edge
                                    of a parent element is used.</p>
                                <p>The value has the type <code>div-dimension</code>.</p>
                                <p>Available platforms: Android, iOS, web.</p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <p>Default value: <code>200</code>.</p>
                                <p>Available platforms: Android, iOS, web.</p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <p><strong>string</strong></p>
                                <p>Edge of a parent element for one of the action types:</p>
                                <li>where the element will move from when appearing;</li>
                                <li>where the element will move to when disappearing.</li>
                                <p></p>
                                <p>Possible values: <code>left</code>, <code>top</code>, <code>right</code>,
                                    <code>bottom</code>.</p>
                                <p>Default value: <code>bottom</code>.</p>
                                <p>Available platforms: Android, iOS, web.</p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <p><strong>string</strong></p>
                                <p>Transition speed nature.</p>
                                <p>Possible values: <code>linear</code>, <code>ease</code>, <code>ease_in</code>,
                                    <code>ease_out</code>, <code>ease_in_out</code>, <code>spring</code>.</p>
                                <p>Default value: <code>ease_in_out</code>.</p>
                                <p>Available platforms: Android, iOS, web.</p>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
            <div class="dc-nav-toc-panel__content">
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                    ...
                    <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-scale-transition"
                            ...
                            <div class="dc-nav-toc-panel__control-name">scale-transition</div>
                        </a></div>
                </div>
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                    ...
                    <div class="dc-nav-toc-panel__control-text"><a
                            href="en/concepts/divs/2/div-change-bounds-transition" target="_self"
                            class="dc-nav-toc-panel__link" data-router-shallow="true">
                            <div class="dc-nav-toc-panel__control-name">change-bounds-transition</div><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 16 16">
                                <path fill="currentColor" fill-rule="evenodd"
