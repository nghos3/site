    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-text"
                            aria-current="page">text</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-text</span></h1>
                <div class="dc-doc-page__page-contributors"></div>
                <div class="dc-doc-page__content-mini-toc yfm">
                    <ul>
                        <li><a href="en/concepts/divs/2/div-text#parameters">Parameters</a>
                            <ul>
                                <li><a href="en/concepts/divs/2/div-text#range">range</a></li>
                                <li><a href="en/concepts/divs/2/div-text#image">image</a></li>
                                <li><a href="en/concepts/divs/2/div-text#accessibility">accessibility</a></li>
                                <li><a href="en/concepts/divs/2/div-text#ellipsis">ellipsis</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Text.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-text#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Required parameter.</p>
                                    <p>The value must always be <code>text</code>.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>One action when clicking on an element. Not used if the <code>actions</code>
                                        parameter is set.</p>
                                    <p>The value has the type <code>div-action</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>action_animation</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Click animation. The web only supports the following values: <code>fade</code>,
                                        <code>scale</code>, <code>native</code>, <code>no_animation</code> and
                                        <code>set</code>.</p>
                            ...
                            <tr>
                                <td><code>auto_ellipsize</code></td>
                                <td>
                            ...
                            <tr>
                                <td><code>doubletap_actions</code></td>
                                <td>
                                    <p><strong>array</strong></p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Text cropping marker. It is displayed when text size exceeds the limit on the number
                                        of lines.</p>
                                    <p>The value has the type <code>ellipsis</code>.</p>
                            ...
                            <tr>
                                <td><code>focused_text_color</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Text color when focusing on the element.</p>
                                    <p>Valid formats: <code>#RGB</code>, <code>#ARGB</code>, <code>#RRGGBB</code>,
                                        <code>#AARRGGBB</code>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Font family:</p>
                                    <li><code>text</code> — a standard text font;</li>
                                    <li><code>display</code> — a family of fonts with a large font size.</li>
                                    <p></p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>font_feature_settings</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>List of OpenType font features. The format matches the CSS attribute
                                        "font-feature-settings". Learn more:
                                        https://www.w3.org/TR/css-fonts-3/#font-feature-settings-prop</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><code>font_size_unit</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Possible values: <code>dp</code>, <code>sp</code>, <code>px</code>.</p>
                                    <p>Default value: <code>sp</code>.</p>
                                    <p>Available platforms: Android, iOS.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Style.</p>
                                    <p>Possible values: <code>light</code>, <code>medium</code>, <code>regular</code>,
                                        <code>bold</code>.</p>
                                    <p>Default value: <code>regular</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>font_weight_value</code></td>
                                <td>
                                    <p><strong>int</strong></p>
                            ...
                            <tr>
                                <td><code>letter_spacing</code></td>
                                <td>
                                    <p><strong>number</strong></p>
                            ...
                            <tr>
                                <td><code>longtap_actions</code></td>
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Action when long-clicking an element. Doesn't work on devices that don't support
                                        touch gestures.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Maximum number of lines not to be cropped when breaking the limits.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>min_hidden_lines</code></td>
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Minimum number of cropped lines when breaking the limits.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                    <p>Available platforms: Android, iOS.</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>A character range in which additional style parameters can be set. Defined by
                                        mandatory <code>start</code> and <code>end</code> fields.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Strikethrough.</p>
                                    <p>Possible values: <code>none</code>, <code>single</code>.</p>
                                    <p>Default value: <code>none</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>text_alignment_horizontal</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Horizontal text alignment.</p>
                                    <p>Possible values: <code>left</code>, <code>center</code>, <code>right</code>,
                                        <code>start</code>, <code>end</code>.</p>
                                    <p>Default value: <code>start</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>text_alignment_vertical</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Vertical text alignment.</p>
                                    <p>Possible values: <code>top</code>, <code>center</code>, <code>bottom</code>,
                                        <code>baseline</code>.</p>
                                    <p>Default value: <code>top</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Text color. Not used if the <code>text_gradient</code> parameter is set.</p>
                                    <p>Valid formats: <code>#RGB</code>, <code>#ARGB</code>, <code>#RRGGBB</code>,
                                        <code>#AARRGGBB</code>.</p>
                                    <p>Default value: <code>#FF000000</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>text_gradient</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Gradient text color.</p>
                                    <p>The value has the type <code>div-text-gradient</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                                            href="en/concepts/divs/2/div-linear-gradient#div-linear-gradient">div-linear-gradient</a>
                            ...
                            <tr>
                                <td><code>text_shadow</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Parameters of the shadow applied to the text.</p>
                                    <p>The value has the type <code>div-shadow</code>.</p>
                                    <p>Available platforms: Android, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>tighten_width</code></td>
                                <td>
                                    <p><strong>bool_int</strong></p>
                                    <p>Set text width to maximal line width, works only with wrap_content width with
                                        constrained=true and max_size set</p>
                                    <p>Default value: <code>false</code>.</p>
                                    <p>Available platforms: Android, iOS.</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Text cropping method. Use <code>ellipsis</code> instead.</p>
                                    <p>Possible values: <code>none</code>, <code>start</code>, <code>end</code>,
                                        <code>middle</code>.</p>
                                    <p>Default value: <code>end</code>.</p>
                                    <p>Available platforms: Android, iOS.</p>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <h3 id="range"><a href="en/concepts/divs/2/div-text#range" class="yfm-anchor"
                            aria-hidden="true"></a>range</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Required parameter.</p>
                                    <p>Ordinal number of the last character to be included in the range.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt; 0</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Required parameter.</p>
                                    <p>Ordinal number of a character which the range begins from. The first character has a
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value has the type <code>div-text-range-background</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                                            href="en/concepts/divs/2/div-solid-background#div-solid-background">div-solid-background</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value has the type <code>div-text-range-border</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <li><code>px</code> — a physical pixel.</li>
                                    <li><code>dp</code> — a logical pixel that doesn't depend on screen density.</li>
                                    <li><code>sp</code> — a logical pixel that depends on the font size on a device. Specify
                                        height in <code>sp</code>. Only available on Android.</li>
                                    <p></p>
                                    <p>Possible values: <code>dp</code>, <code>sp</code>, <code>px</code>.</p>
                                    <p>Default value: <code>sp</code>.</p>
                                    <p>Available platforms: Android, iOS.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Line spacing of the text. Units specified in <code>font_size_unit</code>.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Parameters of the shadow applied to the character range.</p>
                                    <p>The value has the type <code>div-shadow</code>.</p>
                                    <p>Available platforms: Android, web.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Top margin of the character range. Units specified in <code>font_size_unit</code>.
                                    </p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                    ...
                    <h3 id="image"><a href="en/concepts/divs/2/div-text#image" class="yfm-anchor"
                            aria-hidden="true"></a>image</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Required parameter.</p>
                                    <p>A symbol to insert prior to an image. To insert an image at the end of the text,
                                        specify the number of the last character plus one.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>The value has the type <code>accessibility</code>.</p>
                                    <p>Available platforms: Android.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Possible values: <code>top</code>, <code>center</code>, <code>bottom</code>,
                                        <code>baseline</code>.</p>
                                    <p>Default value: <code>center</code>.</p>
                                    <p>Available platforms: Android.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Default value: <code>{`{"type": "fixed","value":20}`}</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>preload_required</code></td>
                                <td>
                                    <p><strong>bool_int</strong></p>
                            ...
                            <tr>
                                <td><code>tint_mode</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Blend mode of the color specified in <code>tint_color</code>.</p>
                                    <p>Possible values: <code>source_in</code>, <code>source_atop</code>,
                                        <code>darken</code>, <code>lighten</code>, <code>multiply</code>,
                                        <code>screen</code>.</p>
                                    <p>Default value: <code>source_in</code>.</p>
                                    <p>Available platforms: Android, web.</p>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <h3 id="accessibility"><a href="en/concepts/divs/2/div-text#accessibility" class="yfm-anchor"
                            aria-hidden="true"></a>accessibility</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Element description. It is used as the main description for screen reading
                                        applications.</p>
                                    <p>Available platforms: Android.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Element role. Used to correctly identify an element by the accessibility service. For
                                        example, the <code>list</code> element is used to group list elements into one
                                        element.</p>
                                    <p>Possible values: <code>none</code>, <code>button</code>, <code>image</code>,
                                        <code>text</code>, <code>auto</code>.</p>
                    ...
                    <h3 id="ellipsis"><a href="en/concepts/divs/2/div-text#ellipsis" class="yfm-anchor"
                            aria-hidden="true"></a>ellipsis</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Character ranges inside a crop marker with different text styles.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-873" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-873" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-873.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-video" target="_self"
                                class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">video</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
