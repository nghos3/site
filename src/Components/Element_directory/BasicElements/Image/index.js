    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-image"
                            aria-current="page">image</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-image</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Image.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-image#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Required parameter.</p>
                                    <p>The value must always be <code>image</code>.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><code>appearance_animation</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Transparency animation when loading an image.</p>
                                    <p>The value has the type <code>div-fade-transition</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Fixed aspect ratio. The element's height is calculated based on the width, ignoring
                                        the <code>height</code> value.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Horizontal image alignment.</p>
                                    <p>Possible values: <code>left</code>, <code>center</code>, <code>right</code>,
                                        <code>start</code>, <code>end</code>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Image filters.</p>
                                    <p>List of possible values:</p>
                                    <li><a href="en/concepts/divs/2/div-blur#div-blur">div-blur</a></li>
                                    <li><a
                                            href="en/concepts/divs/2/div-filter-rtl-mirror#div-filter-rtl-mirror">div-filter-rtl-mirror</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td><code>high_priority_preview_show</code></td>
                                <td>
                                    <p><strong>bool_int</strong></p>
                                    <p>It sets the priority of displaying the preview — the preview is decoded in the main
                                        stream and displayed as the first frame. Use the parameter carefully — it will
                                        worsen the preview display time and can worsen the application launch time.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Placeholder background before the image is loaded.</p>
                                    <p>Valid formats: <code>#RGB</code>, <code>#ARGB</code>, <code>#RRGGBB</code>,
                                        <code>#AARRGGBB</code>.</p>
                                    <p>Default value: <code>#14000000</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Image preview encoded in <code>base64</code>. It will be shown instead of
                                        <code>placeholder_color</code> before the image is loaded. Format
                                        <code>data url</code>: <code>data:[;base64],&lt;data&gt;</code></p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Image scaling:</p>
                                    <li><code>fit</code> places the entire image into the element (free space is filled with
                                        background);</li>
                                    <li><code>fill</code> scales the image to the element size and cuts off the excess.</li>
                                    <p></p>
                                    <p>Possible values: <code>fill</code>, <code>no_scale</code>, <code>fit</code>,
                                        <code>stretch</code>.</p>
                                    <p>Default value: <code>fill</code>.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-429" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-429" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-429.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/grid')}
                                ...
                                <div class="dc-nav-toc-panel__control-name">grid</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/indicator')}
                                target="_self" class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">indicator</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
