          ...
          <ol class="dc-breadcrumbs__items">
            ...
            <li class="dc-breadcrumbs__item">
              <span
                ...
                href="en/concepts/divs/2/div-slider"
                aria-current="page"
              >
                slider
              </span>
      ...
      <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
          <h1 class="dc-doc-page-title dc-doc-page__title">
            <span>div-slider</span>
          </h1>
          <div class="dc-doc-page__page-contributors"></div>
          <div class="dc-doc-page__content-mini-toc yfm">
            <ul>
              <li>
                <a href="en/concepts/divs/2/div-slider#parameters">
                  Parameters
                </a>
                <ul>
                  <li>
                    <a href="en/concepts/divs/2/div-slider#text_style">
                      text_style
                    </a>
                  </li>
                  <li>
                    <a href="en/concepts/divs/2/div-slider#range">range</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
            ...
            <h2 id="parameters">
              <a
                href="en/concepts/divs/2/div-slider#parameters"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              Parameters
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <code>track_inactive_style</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>Required parameter.</p>
                    <p>
                      The value must always be <code>slider</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    <code>secondary_value_accessibility</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                ...
                <tr>
                  <td>
                    <code>thumb_secondary_style</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                ...
                <tr>
                  <td>
                    <code>thumb_secondary_text_style</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                    ...
                    <p>
                      The value has the type <code>text_style</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <code>thumb_secondary_value_variable</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                ...
                <tr>
                  <td>
                    <code>thumb_value_variable</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                ...
                <tr>
                  <td>
                    <code>tick_mark_active_style</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                ...
                <tr>
                  <td>
                    <code>tick_mark_inactive_style</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
            ...
            <h3 id="text_style">
              <a
                href="en/concepts/divs/2/div-slider#text_style"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              text_style
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      The value has the type <code>div-point</code>.
                    </p>
                  </td>
                </tr>
                <tr>
            ...
            <h3 id="range">
              <a
                href="en/concepts/divs/2/div-slider#range"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              range
                ...
                <button class="yfm-clipboard-button" aria-label="Copy">
                  ...
                  >
                    ...
                    >
                      ...
                      ></animate>
                      <animate
                        id="hideAnimation-519"
                        attributeName="visibility"
                        from="visible"
                        to="hidden"
                        dur="1s"
                        begin="visibileAnimation-519.end+1"
                        fill="freeze"
                      ></animate>
                    </path>
                  </svg>
          ...
          <div class="dc-nav-toc-panel__content">
            <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
              ...
              <div class="dc-nav-toc-panel__control-text">
                <a
                  onClick={() =>
                    navigate("/element-directory/basic-elements/separator")
                  }
                  target="_self"
