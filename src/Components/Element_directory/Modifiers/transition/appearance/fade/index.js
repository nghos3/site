...
const Component = () => {
        ...
        <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
            <ol class="dc-breadcrumbs__items">
                ...
                <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                        href="en/concepts/divs/2/div-fade-transition" aria-current="page">fade-transition</span></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
            <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-fade-transition</span><button
            ...
            <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                <p>Transparency animation.</p>
                <h2 id="parameters"><a href="en/concepts/divs/2/div-fade-transition#parameters" class="yfm-anchor"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <p>The value must always be <code>fade</code>.</p>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>Value of the alpha channel which the element starts appearing from or at which it
                                    finishes disappearing.</p>
                        ...
                        <button class="yfm-clipboard-button" aria-label="Copy">
                            <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                ...
                                <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                    visibility="hidden">
                                    <animate id="visibileAnimation-61" attributeName="visibility" from="hidden"
            ...
            <div class="dc-nav-toc-panel__content">
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                    ...
                    <div class="dc-nav-toc-panel__control-text"><a
                            href="en/concepts/divs/2/div-appearance-set-transition" target="_self"
                            ...
                            <div class="dc-nav-toc-panel__control-name">appearance-set-transition</div>
                        </a></div>
                </div>
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                    ...
                    <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-scale-transition"
                            ...
                            <div class="dc-nav-toc-panel__control-name">scale-transition</div><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 16 16">
                                <path fill="currentColor" fill-rule="evenodd"
