    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-trigger" aria-current="page">trigger</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-trigger</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>A trigger that causes an action when activated.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-trigger#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Action when a trigger is activated.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Required parameter.</p>
                                    <p>Condition for activating a trigger. For example,
                                        <code>liked &amp;&amp; subscribed</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Trigger activation mode:</p>
                                    <li><code>on_condition</code> — a trigger is activated when the condition changes from
                                        <code>false</code> to <code>true</code>;</li>
                                    <li><code>on_variable</code> — a trigger is activated when the condition is met and the
                                        variable value changes.</li>
                                    <p></p>
                                    <p>Possible values: <code>on_condition</code>, <code>on_variable</code>.</p>
                                    <p>Default value: <code>on_condition</code>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-change-transition"
                                ...
                                <div class="dc-nav-toc-panel__control-name">change-transition</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-visibility-action"
                                ...
                                <div class="dc-nav-toc-panel__control-name">visibility-action</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
