...
const Component = () => {
        ...
        <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
            <ol class="dc-breadcrumbs__items">
                ...
                <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                        href="en/concepts/divs/2/div-scale-transition" aria-current="page">scale-transition</span></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
            <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-scale-transition</span><button
            ...
            <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                <p>Scale animation.</p>
                <h2 id="parameters"><a href="en/concepts/divs/2/div-scale-transition#parameters" class="yfm-anchor"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <p>The value must always be <code>scale</code>.</p>
                        ...
                        <tr>
                            <td><code>pivot_x</code></td>
                            <td>
                                <p><strong>number</strong></p>
                                <p>Relative coordinate <code>X</code> of the point that won't change its position in
                                    case of scaling.</p>
                        ...
                        <tr>
                            <td><code>pivot_y</code></td>
                            <td>
                                <p><strong>number</strong></p>
                                <p>Relative coordinate <code>Y</code> of the point that won't change its position in
                                    case of scaling.</p>
                                <p>Restriction for the value <code>x</code>:
                                    <code>x &gt;= 0.0 &amp;&amp; x &lt;= 1.0</code>.</p>
                                <p>Default value: <code>0.5</code>.</p>
                        ...
                        <tr>
                            ...
                            <td>
                                <p><strong>number</strong></p>
                                <p>Value of the scale from which the element starts appearing or at which it finishes
                                    disappearing.</p>
                                <p>Restriction for the value <code>x</code>: <code>x &gt;= 0.0</code>.</p>
                                <p>Default value: <code>0.0</code>.</p>
                                <p>Available platforms: Android, iOS, web.</p>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
            <div class="dc-nav-toc-panel__content">
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                    ...
                    <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-fade-transition"
                            ...
                            <div class="dc-nav-toc-panel__control-name">fade-transition</div>
                        </a></div>
                </div>
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                    <div class="dc-nav-toc-panel__control-hint">Next</div>
                    <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-slide-transition"
                            target="_self" class="dc-nav-toc-panel__link" data-router-shallow="true">
                            <div class="dc-nav-toc-panel__control-name">slide-transition</div><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 16 16">
                                <path fill="currentColor" fill-rule="evenodd"
