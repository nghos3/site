    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-grid"
                            aria-current="page">grid</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-grid</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>A grid with an option to merge cells vertically and horizontally.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-grid#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Required parameter.</p>
                                    <p>The value must always be <code>grid</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Horizontal alignment of grid contents.</p>
                                    <p>Possible values: <code>left</code>, <code>center</code>, <code>right</code>,
                                        <code>start</code>, <code>end</code>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Vertical alignment of grid contents.</p>
                                    <p>Possible values: <code>top</code>, <code>center</code>, <code>bottom</code>,
                                        <code>baseline</code>.</p>
                ...
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/gif-image')} class="dc-nav-toc-panel__link" data-router-shallow="true"><svg
                                ...
                                <div class="dc-nav-toc-panel__control-name">gif-image</div>
                            </a></div>
                    </div>
