...
const Component = () => {
    ...
    <div class="dc-doc-page__breadcrumbs">
        <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
            <ol class="dc-breadcrumbs__items">
                ...
                <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-shadow"
                        aria-current="page">shadow</span></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
            <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-shadow</span><button
            ...
            <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                <p>Element shadow.</p>
                <h2 id="parameters"><a href="en/concepts/divs/2/div-shadow#parameters" class="yfm-anchor"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>Default value: <code>0.19</code>.</p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p>Default value: <code>#000000</code>.</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="dc-nav-toc-panel__content">
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                    ...
                    <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-point" target="_self"
                            ...
                            <div class="dc-nav-toc-panel__control-name">point</div>
                        </a></div>
                </div>
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                    ...
                    <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-shape" target="_self"
                            ...
                            <div class="dc-nav-toc-panel__control-name">shape</div><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 16 16">
                                <path fill="currentColor" fill-rule="evenodd"
