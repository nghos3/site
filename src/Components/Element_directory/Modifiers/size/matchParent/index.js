            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-match-parent-size" aria-current="page">match-parent-size</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    ...
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-match-parent-size#parameters" class="yfm-anchor"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Weight when distributing free space between elements with the size type
                                        <code>match_parent</code> inside an element. If the weight isn't specified, the
                                        elements will divide the place equally.</p>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-wrap-content-size"
