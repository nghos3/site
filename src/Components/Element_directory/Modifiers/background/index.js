        ...
        <main class="dc-doc-page__content">
          ...
          <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
            ...
            <ul>
              <li>
                <a
                  style={{ color: "rgb(2, 123, 243)" }}
                  onClick={() =>
                    navigate(
                      "/element-directory/modifiers/background/linear-gradient"
                    )
                  }
                >
                  div-linear-gradient
              ...
              <li>
                <a
                  ...
                  onClick={() =>
                    navigate(
                      "/element-directory/modifiers/background/image-background"
                    )
                  }
                >
              ...
              <li>
                <a
                  ...
                  onClick={() =>
                    navigate(
                      "/element-directory/modifiers/background/solid-background"
                    )
                  }
                >
              ...
              <li>
                <a
                  ...
                  onClick={() =>
                    navigate(
                      "/element-directory/modifiers/background/nine-patch-background"
                    )
                  }
                >
