          ...
          <ol class="dc-breadcrumbs__items">
            ...
            <li class="dc-breadcrumbs__item">
              <span
                ...
                href="en/concepts/divs/2/div-select"
                aria-current="page"
              >
                select
              </span>
      ...
      <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
          ...
          <div class="dc-doc-page__content-mini-toc yfm">
            <ul>
              <li>
                <a href="en/concepts/divs/2/div-select#parameters">
                  Parameters
                </a>
                <ul>
                  <li>
                    <a href="en/concepts/divs/2/div-select#option">option</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
            ...
            <h2 id="parameters">
              <a
                href="en/concepts/divs/2/div-select#parameters"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              Parameters
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>Required parameter.</p>
                    <p>
                      The value must always be <code>select</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Default value: <code>#73000000</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
            ...
            <h3 id="option">
              <a
                href="en/concepts/divs/2/div-select#option"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              option
                ...
                <button class="yfm-clipboard-button" aria-label="Copy">
                  ...
                  >
                    ...
                    >
                      ...
                      ></animate>
                      <animate
                        id="hideAnimation-414"
                        attributeName="visibility"
                        from="visible"
                        to="hidden"
                        dur="1s"
                        begin="visibileAnimation-414.end+1"
                        fill="freeze"
                      ></animate>
                    </path>
                  </svg>
          ...
          <div class="dc-nav-toc-panel__content">
            <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
              ...
              <div class="dc-nav-toc-panel__control-text">
                <a
                  onClick={() =>
                    navigate("/element-directory/basic-elements/pager")
                  }
