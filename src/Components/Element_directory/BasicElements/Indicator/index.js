    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-indicator" aria-current="page">indicator</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-indicator</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Progress indicator for <a href="en/concepts/divs/2/div-pager">pager</a>.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-indicator#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>indicator</code>.</p>
                            ...
                            <tr>
                                <td><code>active_item_color</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    ...
                                    <p>Default value: <code>#ffdc60</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>active_item_size</code></td>
                                <td>
                                    <p><strong>number</strong></p>
                                    <p>Parameter is deprecated.</p>
                                    <p>A size multiplier for an active indicator.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt; 0</code>.</p>
                                    <p>Default value: <code>1.3</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>active_shape</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Active indicator shape.</p>
                                    <p>The value has the type <code>div-rounded-rectangle-shape</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Possible values: <code>scale</code>, <code>worm</code>, <code>slider</code>.</p>
                                    <p>Default value: <code>scale</code>.</p>
                            ...
                            <tr>
                                <td><code>inactive_item_color</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Parameter is deprecated.</p>
                                    <p>Indicator color.</p>
                                    <p>Valid formats: <code>#RGB</code>, <code>#ARGB</code>, <code>#RRGGBB</code>,
                                        <code>#AARRGGBB</code>.</p>
                                    <p>Default value: <code>#33919cb5</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>inactive_minimum_shape</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Inactive indicator shape, minimum size. Used when all the indicators don't fit on the
                                        screen.</p>
                                    <p>The value has the type <code>div-rounded-rectangle-shape</code>.</p>
                                    <p>Available platforms: Android, iOS.</p>
                                </td>
                            ...
                            <tr>
                                <td><code>inactive_shape</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Indicator shape.</p>
                                    <p>The value has the type <code>div-rounded-rectangle-shape</code>.</p>
                            ...
                            <tr>
                                <td><code>items_placement</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Indicator items placement mode:</p>
                                    <li>Default: Indicators' width is fixed and defined by the <code>shape</code>
                                        parameters.</li>
                                    <li>Stretch: Indicators are expanded to fill the entire width.</li>
                                    <p></p>
                                    <p>The value has the type <code>div-indicator-item-placement</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                                            href="en/concepts/divs/2/div-default-indicator-item-placement#div-default-indicator-item-placement">div-default-indicator-item-placement</a>
                                    </li>
                                    <li><a
                                            href="en/concepts/divs/2/div-stretch-indicator-item-placement#div-stretch-indicator-item-placement">div-stretch-indicator-item-placement</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td><code>minimum_item_size</code></td>
                                <td>
                                    <p><strong>number</strong></p>
                                    <p>Parameter is deprecated.</p>
                                    <p>A size multiplier for a minimal indicator. It is used when the required number of
                                        indicators don't fit on the screen.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt; 0</code>.</p>
                            ...
                            <tr>
                                <td><code>pager_id</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>ID of the pager that is a data source for an indicator.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Parameter is deprecated.</p>
                                    <p>Indicator shape.</p>
                                    <p>The value has the type <code>div-shape</code>.</p>
                                    <p>Default value: <code>{`{"type":"rounded_rectangle"}`}</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                                            href="en/concepts/divs/2/div-rounded-rectangle-shape#div-rounded-rectangle-shape">div-rounded-rectangle-shape</a>
                                    </li>
                                    <li><a href="en/concepts/divs/2/div-circle-shape#div-circle-shape">div-circle-shape</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>space_between_centers</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Parameter is deprecated.</p>
                                    <p>Spacing between indicator centers.</p>
                                    <p>The value has the type <code>div-fixed-size</code>.</p>
                                    <p>Default value: <code>{`{"type": "fixed","value":15}`}</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-381" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-381" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-381.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
                ...
                <div class="dc-nav-toc-panel__content">
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-input" target="_self"
                                ...
                                <div class="dc-nav-toc-panel__control-name">input</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
