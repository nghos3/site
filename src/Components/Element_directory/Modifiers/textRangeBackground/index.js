...
const Component = () => {
        ...
        <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
            <ol class="dc-breadcrumbs__items">
                ...
                <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                        ...
                        aria-current="page">text-range-background</span></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
            <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-text-range-background</span><button
            ...
            <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                ...
                <ul>
                    <li><a href="/element-directory/modifiers/background/solid-background">div-solid-background</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="dc-nav-toc-panel__content">
                <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                    ...
                    <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-text-gradient"
                            ...
                            <div class="dc-nav-toc-panel__control-name">text-gradient</div>
                        </a></div>
                </div>
