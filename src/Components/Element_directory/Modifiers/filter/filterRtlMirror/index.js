    ...
    return (<div class="dc-doc-layout__center">
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-filter-rtl-mirror</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Mirrors an image if the system uses RTL (Right-to-Left) text direction.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-filter-rtl-mirror#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>rtl_mirror</code>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left"></div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right"></div>
                </div>
            </div>
        </div>
