    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-animation" aria-current="page">animation</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-animation</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    ...
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-animation#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Animation type.</p>
                                    <p>Possible values: <code>fade</code>, <code>translate</code>, <code>scale</code>,
                                        <code>native</code>, <code>set</code>, <code>no_animation</code>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Animation speed nature. When the value is set to <code>spring</code> — animation of
                                        damping fluctuations cut to 0.7 with the <code>damping=1</code> parameter. Other
                                        options correspond to the Bezier curve:</p>
                                    <li><code>linear</code> — cubic-bezier(0, 0, 1, 1);</li>
                                    <li><code>ease</code> — cubic-bezier(0.25, 0.1, 0.25, 1);</li>
                                    <li><code>ease_in</code> — cubic-bezier(0.42, 0, 1, 1);</li>
                                    <li><code>ease_out</code> — cubic-bezier(0, 0, 0.58, 1);</li>
                                    <li><code>ease_in_out</code> — cubic-bezier(0.42, 0, 0.58, 1).</li>
                                    <p></p>
                                    ...
                                    <p>Default value: <code>spring</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value has the type <code>div-count</code>.</p>
                                    <p>Default value: </p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                                            href="en/concepts/divs/2/div-infinity-count#div-infinity-count">div-infinity-count</a>
                                    </li>
                                    <li><a href="en/concepts/divs/2/div-fixed-count#div-fixed-count">div-fixed-count</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-action" target="_self"
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-aspect" target="_self"
                                class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">aspect</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
