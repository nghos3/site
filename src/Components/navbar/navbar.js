...
const renderItems = (items) => {
    return (
      <ul className="dc-toc__list" aria-labelledby={uuidv4()}>
        {items.map(item => (
          <li id={uuidv4()} className="dc-toc__list-item dc-toc__list-item_main  dc-toc__list-item_opened">
                {item.children && <button  className="dc-toc-item__text dc-toc-item__text_clicable" aria-expanded="true"
                aria-label={`Drop-down ${item.name}`} list><svg xmlns="http://www.w3.org/2000/svg" width="16"
                ...
                </svg>{!item.path && <span>{item.name}</span>}
                  {item.path && <a href={`${item.path}`} target="_self" className="dc-toc-item__link" data-router-shallow="true">
                <div className="dc-toc-item__text dc-toc-item__text_clicable">
                    <span>{item.name}</span>
                </div>
              </a>}</button>}
              {!item.children && <a href={`${item.path}`} target="_self" className="dc-toc-item__link" data-router-shallow="true">
                <div className="dc-toc-item__text dc-toc-item__text_clicable">
                    <span>{item.name}</span>
                </div>
              </a>}
  ...
  const items = [
    ...
    // },
    {
      ...
      children: [
        ...
        {name: 'Modifiers',
            children: [
                {name: "absolute-edge-insets", path: '/element-directory/modifiers/absolute-edge-insets'},
                {name: "accessibility", path: '/element-directory/modifiers/accessibility'},
                ...
                {name: "background", path: '/element-directory/modifiers/background', children: [
                 { name: "linear-gradient", path: "/element-directory/modifiers/background/linear-gradient"},
                 { name: "radial-gradient", path: "/element-directory/modifiers/background/radial-gradient", children: [
                  { name: "radial-gradient-center", path: "/element-directory/modifiers/background/radial-gradient/center",
                    children: [ { name: "fixed-center", path: "/element-directory/modifiers/background/radial-gradient/center/fixed" },
                      { name: "relative-center", path: "/element-directory/modifiers/background/radial-gradient/center/relative" }]},
                  { name: "radial-gradient-radius", path: "/element-directory/modifiers/background/radial-gradient/radius", 
                    children: [
                      { name: "relative-radius", path: "/element-directory/modifiers/background/radial-gradient/radius/relative" }
                    ]
                  },
                 ]},
                 { name: "image-background", path: "/element-directory/modifiers/background/image-background"},
                 { name: "solid-background", path: "/element-directory/modifiers/background/solid-background"},
                 { name: "nine-patch-background", path: "/element-directory/modifiers/background/nine-patch-background"}
                ]},
                {name: "border", path: '/element-directory/modifiers/border'},
                {name: "corners-radius", path: '/element-directory/modifiers/corners-radius'},
                {name: "count", path: '/element-directory/modifiers/count', children: [
                  {name: "count-infinity", path: '/element-directory/modifiers/count/infinity'},
                  {name: "count-fixed", path: '/element-directory/modifiers/count/fixed'}
                ]},
                {name: "dimention", path: '/element-directory/modifiers/dimention'},
                {name: "drawable", path: '/element-directory/modifiers/drawable', children: [
                  {name: "shape-drawable", path: '/element-directory/modifiers/drawable/shape-drawable'}
                ]},
                {name: "edge-inets", path: '/element-directory/modifiers/edge-insets'},
                {name: "extension", path: '/element-directory/modifiers/extension'},
                {name: "filter", path: '/element-directory/modifiers/filter', children: [
                  {name: 'blur', path: '/element-directory/modifiers/filter/blur'},
                  {name: 'filter-rtl-mirror', path: '/element-directory/modifiers/filter/filter-rtl-mirror'}
                ]},
                {name: "focus", path: '/element-directory/modifiers/focus'},
                {name: "indicator-item-placement", path: '/element-directory/modifiers/indicator-item-placement', children: [
