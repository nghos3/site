          ...
          <ol class="dc-breadcrumbs__items">
            ...
            <li class="dc-breadcrumbs__item">
              <span
                ...
                href="en/concepts/divs/2/div-action"
                aria-current="page"
              >
                action
              </span>
      ...
      <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
          <h1 class="dc-doc-page-title dc-doc-page__title">
            <span>div-action</span>
          </h1>
          <div class="dc-doc-page__page-contributors"></div>
          <div class="dc-doc-page__content-mini-toc yfm">
            <ul>
              <li>
                <a href="en/concepts/divs/2/div-action#parameters">
                  Parameters
                </a>
                <ul>
                  <li>
                    <a href="en/concepts/divs/2/div-action#menu_item">
                      menu_item
                    </a>
                  </li>
                </ul>
          ...
          <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
            <p>It defines an action when clicking on an element.</p>
            <h2 id="parameters">
              <a
                href="en/concepts/divs/2/div-action#parameters"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              Parameters
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      <a href="en/concepts/interaction#loading-data">
                        data loading
                      </a>
                      .
                    </p>
                    <p>
                      The value has the type <code>div-download-callbacks</code>
                      .
                    </p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      listening to their associated event (clicks, changes in
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>The tab in which the URL must be opened.</p>
                    <p>
                      Possible values: <code>_self</code>, <code>_blank</code>.
                    </p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      The value has the type <code>div-action-typed</code>.
                    </p>
                    <p>List of possible values:</p>
                    <li>
                      <a href="en/concepts/divs/2/div-action-animator-start#div-action-animator-start">
                        div-action-animator-start
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-animator-stop#div-action-animator-stop">
                        div-action-animator-stop
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-array-insert-value#div-action-array-insert-value">
                        div-action-array-insert-value
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-array-remove-value#div-action-array-remove-value">
                        div-action-array-remove-value
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-array-set-value#div-action-array-set-value">
                        div-action-array-set-value
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-clear-focus#div-action-clear-focus">
                        div-action-clear-focus
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-copy-to-clipboard#div-action-copy-to-clipboard">
                        div-action-copy-to-clipboard
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-dict-set-value#div-action-dict-set-value">
                        div-action-dict-set-value
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-download#div-action-download">
                        div-action-download
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-focus-element#div-action-focus-element">
                        div-action-focus-element
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-hide-tooltip#div-action-hide-tooltip">
                        div-action-hide-tooltip
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-scroll-by#div-action-scroll-by">
                        div-action-scroll-by
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-scroll-to#div-action-scroll-to">
                        div-action-scroll-to
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-set-state#div-action-set-state">
                        div-action-set-state
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-set-stored-value#div-action-set-stored-value">
                        div-action-set-stored-value
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-set-variable#div-action-set-variable">
                        div-action-set-variable
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-show-tooltip#div-action-show-tooltip">
                        div-action-show-tooltip
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-timer#div-action-timer">
                        div-action-timer
                      </a>
                    </li>
                    <li>
                      <a href="en/concepts/divs/2/div-action-video#div-action-video">
                        div-action-video
                      </a>
                    </li>
                    <p></p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      URL. Possible values: <code>url</code> or
                      <code>div-action://</code>. To learn more, see
                      <a href="en/concepts/interaction">
            ...
            <h3 id="menu_item">
              <a
                href="en/concepts/divs/2/div-action#menu_item"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              menu_item
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      <code>actions</code> parameter is set.
                    </p>
                    <p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>Multiple actions when clicking on a menu item.</p>
                  </td>
                </tr>
              </tbody>
            </table>
                ...
                <button class="yfm-clipboard-button" aria-label="Copy">
                  ...
                  >
                    ...
                    >
                      ...
                      ></animate>
                      <animate
                        id="hideAnimation-150"
                        attributeName="visibility"
                        from="visible"
                        to="hidden"
                        dur="1s"
                        begin="visibileAnimation-150.end+1"
                        fill="freeze"
                      ></animate>
                    </path>
                  </svg>
          ...
          <div class="dc-nav-toc-panel__content">
            <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
              ...
              <div class="dc-nav-toc-panel__control-text">
                <a
                  onClick={() =>
                    navigate("/element-directory/modifiers/accessibility")
                  }
            ...
            <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
              ...
              <div class="dc-nav-toc-panel__control-text">
                <a
                  onClick={() =>
                    navigate("/element-directory/modifiers/animation")
                  }
                  class="dc-nav-toc-panel__link"
                  data-router-shallow="true"
                >
