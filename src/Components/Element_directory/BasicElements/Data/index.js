    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-data"
                            aria-current="page">data</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-data</span></h1>
                <div class="dc-doc-page__page-contributors"></div>
                <div class="dc-doc-page__content-mini-toc yfm">
                    <ul>
                        <li><a href="en/concepts/divs/2/div-data#parameters">Parameters</a>
                            <ul>
                                <li><a href="en/concepts/divs/2/div-data#state">state</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Root structure.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-data#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Required parameter.</p>
                                    <p>A set of visual element states. Each element can have a few states with a different
                                        layout. The states are displayed strictly one by one and switched using <a
                                            href="en/concepts/divs/2/div-action">action</a>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Events that trigger transition animations.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Triggers for changing variables.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Declaration of variables that can be used in an element.</p>
                    ...
                    <h3 id="state"><a href="en/concepts/divs/2/div-data#state" class="yfm-anchor"
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        ...
                                        <animate id="hideAnimation-102" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-102.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/custom')} target="_self"
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/gallery')}target="_self"
                                class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">gallery</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
