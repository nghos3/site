    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><a class="dc-breadcrumbs__text dc-breadcrumbs__text_link"
                            href="en/concepts/divs/2/div-shape">shape</a></li>
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-rounded-rectangle-shape"
                            aria-current="page">rounded-rectangle-shape</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-rounded-rectangle-shape</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>A rectangle with rounded corners.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-rounded-rectangle-shape#parameters"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>rounded_rectangle</code>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Corner rounding radius.</p>
                                    <p>The value has the type <code>div-fixed-size</code>.</p>
                                    <p>Default value: {`<code>{"type":"fixed","value":5}</code>.`}</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>item_height</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Height.</p>
                                    <p>The value has the type <code>div-fixed-size</code>.</p>
                                    <p>Default value: {`<code>{"type":"fixed","value":10}</code>.`}</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-shape" target="_self"
                                ...
                                <div class="dc-nav-toc-panel__control-name">shape</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-circle-shape"
                                target="_self" class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">circle-shape</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
