          ...
          <ol class="dc-breadcrumbs__items">
            ...
            <li class="dc-breadcrumbs__item">
              <span
                ...
                href="en/concepts/divs/2/div-container"
                aria-current="page"
              >
                container
              </span>
      ...
      <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
          ...
          <div class="dc-doc-page__content-mini-toc yfm">
            <ul>
              <li>
                <a href="en/concepts/divs/2/div-container#parameters">
                  Parameters
                </a>
                <ul>
                  <li>
                    <a href="en/concepts/divs/2/div-container#separator">
                      separator
                    </a>
                  </li>
                </ul>
          ...
          <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
            <p>
              Container. It contains other elements and is responsible for their
              location. It is used to arrange elements vertically, horizontally,
              and with an overlay in a certain order, simulating the third
              dimension.
            </p>
            <h2 id="parameters">
              <a
                href="en/concepts/divs/2/div-container#parameters"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              Parameters
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      The value must always be <code>container</code>.
                    </p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      is calculated based on the width, ignoring the{" "}
                      <code>height</code> parameter's value.{" "}
                    </p>
                    <p>
                      On the web, support for the <code>aspect-ratio</code> CSS
                      property is required to use this parameter.
                    </p>
                    <p>
                      The value has the type <code>div-aspect</code>.
                    </p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>
                    <code>content_alignment_horizontal</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                    ...
                    <p>
                      Horizontal element alignment. For child elements, it can
                      be redefined using the
                      <code>alignment_horizontal</code> property.
                    </p>
                    <p>
                      Possible values: <code>left</code>, <code>center</code>,{" "}
                      <code>right</code>,<code>start</code>, <code>end</code>,{" "}
                ...
                <tr>
                  <td>
                    <code>content_alignment_vertical</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                    ...
                    <p>
                      Vertical element alignment. The <code>baseline</code>{" "}
                      value aligns elements along their own specified baseline
                      (for text and other elements that have a baseline).
                      Elements that don't have their baseline value specified
                      are aligned along the top edge. For child elements, it can
                      be redefined using the
                      <code>alignment_vertical</code> property.
                    </p>
                    <p>
                      Possible values: <code>top</code>, <code>center</code>,{" "}
                      <code>bottom</code>,<code>baseline</code>,{" "}
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Sets collection elements dynamically using{" "}
                      <code>data</code> and
                      <code>prototypes</code>.
                    </p>
                    <p>
                      The value has the type{" "}
                      <code>div-collection-item-builder</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Element placement method. The <code>wrap</code> value
                      transfers elements to the next line if they don't fit in
                      the previous one. If the <code>wrap</code> value is set:
                    </p>
                    <li>
                      A separate line is allocated for each element along the
                      main axis with the size value set to{" "}
                      <code>match_parent</code>.
                    </li>
                    <li>
                      Elements along the cross axis with the size value{" "}
                      <code>match_parent</code> are ignored.
                    </li>
                    <p></p>
                    <p>
                      Possible values: <code>no_wrap</code>, <code>wrap</code>.
                    </p>
                    <p>
                      Default value: <code>no_wrap</code>.
                    </p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      if the
                      <code>layout_mode</code> parameter is set to{" "}
                      <code>no_wrap</code>. Only new browsers are supported on
                      the web (the <code>gap</code> property must be supported
                      for flex blocks).
                    </p>
                    <p>
                      The value has the type <code>separator</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Location of elements. <code>overlap</code> value overlays
                      elements on top of each other in the order of enumeration.
                      The lowest is the zero element of an array.
                    </p>
                    <p>
                      Possible values: <code>vertical</code>,{" "}
                      <code>horizontal</code>,<code>overlap</code>.
                    </p>
                    <p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Separator between elements along the main axis. Not used
                      if the
                      <code>orientation</code> parameter is set to{" "}
                      <code>overlap</code>. Only new browsers are supported on
                      the web (the <code>gap</code> property must be supported
                      for flex blocks).
                    </p>
                    <p>
            ...
            <h3 id="separator">
              <a
                href="en/concepts/divs/2/div-container#separator"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              separator
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <p>Separator style.</p>
                    <p>
                      The value has the type <code>div-drawable</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                    <p>List of possible values:</p>
                    <li>
                      <a href="en/concepts/divs/2/div-shape-drawable#div-shape-drawable">
                        div-shape-drawable
                      </a>
                    </li>
                    <p></p>
          ...
          <div class="dc-nav-toc-panel__content">
            ...
            <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
              ...
              <div class="dc-nav-toc-panel__control-text">
                <a
                  onClick={() =>
                    navigate("/element-directory/basic-elements/custom")
                  }
                  class="dc-nav-toc-panel__link"
                  data-router-shallow="true"
                >
                  <div class="dc-nav-toc-panel__control-name">custom</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
