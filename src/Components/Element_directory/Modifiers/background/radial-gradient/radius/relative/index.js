    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><a class="dc-breadcrumbs__text dc-breadcrumbs__text_link"
                            href="en/concepts/divs/2/div-radial-gradient-radius">radial-gradient-radius</a></li>
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-radial-gradient-relative-radius"
                            aria-current="page">radial-gradient-relative-radius</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-radial-gradient-relative-radius</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Relative radius of the gradient transition.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-radial-gradient-relative-radius#parameters"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>relative</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Required parameter.</p>
                                    <p>Type of the relative radius of the gradient transition.</p>
                                    <p>Possible values: <code>nearest_corner</code>, <code>farthest_corner</code>,
                                        <code>nearest_side</code>, <code>farthest_side</code>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-37" attributeName="visibility" from="hidden"
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-radial-gradient-radius"
                                ...
                                <div class="dc-nav-toc-panel__control-name">radial-gradient-radius</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-image-background"
                                target="_self" class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">image-background</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
