    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-slider"
                            aria-current="page">slider</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-slider</span></h1>
                <div class="dc-doc-page__page-contributors"></div>
                <div class="dc-doc-page__content-mini-toc yfm">
                    <ul>
                        <li><a href="en/concepts/divs/2/div-slider#parameters">Parameters</a>
                            <ul>
                                <li><a href="en/concepts/divs/2/div-slider#text_style">text_style</a></li>
                                <li><a href="en/concepts/divs/2/div-slider#range">range</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Slider for selecting a value in the range.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-slider#parameters" class="yfm-anchor"
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td><code>thumb_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Required parameter.</p>
                                    <p>Style of the first pointer.</p>
                            ...
                            <tr>
                                <td><code>track_active_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Required parameter.</p>
                                    <p>Style of the active part of a scale.</p>
                                    <p>The value has the type <code>div-drawable</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                            ...
                            <tr>
                                <td><code>track_inactive_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Required parameter.</p>
                                    <p>Style of the inactive part of a scale.</p>
                                    <p>The value has the type <code>div-drawable</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Required parameter.</p>
                                    <p>The value must always be <code>slider</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Maximum value. It must be greater than the minimum value.</p>
                            ...
                            <tr>
                                <td><code>secondary_value_accessibility</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Accessibility settings for the second pointer.</p>
                                    <p>The value has the type <code>div-accessibility</code>.</p>
                            ...
                            <tr>
                                <td><code>thumb_secondary_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Style of the second pointer.</p>
                                    <p>The value has the type <code>div-drawable</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                            ...
                            <tr>
                                <td><code>thumb_secondary_text_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Text style in the second pointer.</p>
                                    <p>The value has the type <code>text_style</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>thumb_secondary_value_variable</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Name of the variable to store the second pointer's current value.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>thumb_text_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Text style in the first pointer.</p>
                                    <p>The value has the type <code>text_style</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>thumb_value_variable</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Name of the variable to store the pointer's current value.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>tick_mark_active_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Style of active serifs.</p>
                                    <p>The value has the type <code>div-drawable</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                            ...
                            <tr>
                                <td><code>tick_mark_inactive_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Style of inactive serifs.</p>
                                    <p>The value has the type <code>div-drawable</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a
                    ...
                    <h3 id="text_style"><a href="en/concepts/divs/2/div-slider#text_style" class="yfm-anchor"
                            aria-hidden="true"></a>text_style</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Shift relative to the center.</p>
                    ...
                    <h3 id="range"><a href="en/concepts/divs/2/div-slider#range" class="yfm-anchor"
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Section margins. Only uses horizontal margins.</p>
                                    <p>The value has the type <code>div-edge-insets</code>.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-519" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-519" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-519.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-separator"
                                ...
                                <div class="dc-nav-toc-panel__control-name">separator</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-state" target="_self"
                                class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">state</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
