    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-select"
                            aria-current="page">select</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-select</span></h1>
                <div class="dc-doc-page__page-contributors"></div>
                <div class="dc-doc-page__content-mini-toc yfm">
                    <ul>
                        <li><a href="en/concepts/divs/2/div-select#parameters">Parameters</a>
                            <ul>
                                <li><a href="en/concepts/divs/2/div-select#option">option</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>List of options with only one to be selected.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-select#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Required parameter.</p>
                                    <p>The value must always be <code>select</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Required parameter.</p>
                                    <p>Name of the variable that stores the selected option value (<code>value</code>).</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Line spacing of the text. Measured in units set in <code>font_size_unit</code>.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                    ...
                    <h3 id="option"><a href="en/concepts/divs/2/div-select#option" class="yfm-anchor"
                            aria-hidden="true"></a>option</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Text description of the option displayed in the list. If not set, <code>value</code>
                                        is used instead.</p>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-414" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-414" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-414.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-pager" target="_self"
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-separator"
                                ...
                                <div class="dc-nav-toc-panel__control-name">separator</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
