          ...
          <ol class="dc-breadcrumbs__items">
            ...
            <li class="dc-breadcrumbs__item">
              <span
                ...
                href="en/concepts/divs/2/div-video"
                aria-current="page"
              >
                video
              </span>
      ...
      <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
          ...
          <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
            ...
            <h2 id="parameters">
              <a
                href="en/concepts/divs/2/div-video#parameters"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              Parameters
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      The value must always be <code>video</code>.
                    </p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      based on the width, ignoring the <code>height</code>{" "}
                      value.
                    </p>
                    <p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      the video starts if muted playback is turned on.
                    </p>
                    <p>
                ...
                <tr>
                  <td>
                    <code>elapsed_time_variable</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                ...
                <tr>
                  <td>
                    <code>player_settings_payload</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Video preview encoded in <code>base64</code>. Will be
                      shown until the video is ready to play.{" "}
                      <code>Data url</code> format:{" "}
                      <code>data:[;base64],&lt;data&gt;</code>
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>Video scaling:</p>
                    <li>
                      <code>fit</code> places the entire video into the element
                      (free space is filled with background);
                    </li>
                    <li>
                      <code>fill</code> scales the video to the element size and
                      cuts off anything that's extra.
                    </li>
                    <p></p>
                    <p>
                      Possible values: <code>fill</code>, <code>no_scale</code>,{" "}
                      <code>fit</code>.
                    </p>
                    <p>
                      Default value: <code>fit</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                ...
                <button class="yfm-clipboard-button" aria-label="Copy">
                  ...
                  >
                    ...
                    >
                      ...
                      ></animate>
                      <animate
                        id="hideAnimation-405"
                        attributeName="visibility"
                        from="visible"
                        to="hidden"
                        dur="1s"
                        begin="visibileAnimation-405.end+1"
                        fill="freeze"
                      ></animate>
                    </path>
                  </svg>
            ...
            <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
              ...
              <div class="dc-nav-toc-panel__control-text">
                <a
                  onClick={() =>
                    navigate(
                      "/element-directory/modifiers/absolute-edge-insets"
                    )
                  }
                  target="_self"
                  class="dc-nav-toc-panel__link"
