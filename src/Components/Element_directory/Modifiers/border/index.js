    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-border"
                            aria-current="page">border</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-border</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Stroke around the element.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-border#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>One radius of element and stroke corner rounding. Has a lower priority than
                                        <code>corners_radius</code>.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>corners_radius</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Multiple radii of element and stroke corner rounding.</p>
                                    <p>The value has the type <code>div-corners-radius</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>has_shadow</code></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Parameters of the shadow applied to the element stroke.</p>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-nine-patch-background"
                                ...
                                <div class="dc-nav-toc-panel__control-name">nine-patch-background</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-corners-radius"
                                target="_self" class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">corners-radius</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
