    ...
    return (<div class="dc-doc-layout__center">
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-video"
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-video</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Video.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-video#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>video</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>video_sources</code></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>This option turns on automatic video playback. On the web, the video starts if muted
                                        playback is turned on.</p>
                            ...
                            <tr>
                                <td><code>buffering_actions</code></td>
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Actions performed during video loading.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><code>elapsed_time_variable</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Time interval from the video beginning to the current position in milliseconds.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Actions performed after the video ends.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><code>fatal_actions</code></td>
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Actions performed when playback can't be continued due to a player error.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><code>pause_actions</code></td>
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Actions performed when playback is paused.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>player_settings_payload</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Additional information that can be used in the player.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Video preview encoded in <code>base64</code>. Will be shown until the video is ready
                                        to play. <code>Data url</code> format: <code>data:[;base64],&lt;data&gt;</code></p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>bool_int</strong></p>
                                    <p>This option turns on video repeat.</p>
                                    <p>Default value: <code>false</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>resume_actions</code></td>
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Actions performed when video playback resumes.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Video scaling:</p>
                                    <li><code>fit</code> places the entire video into the element (free space is filled with
                                        background);</li>
                                    <li><code>fill</code> scales the video to the element size and cuts off anything that's
                                        extra.</li>
                                    <p></p>
                                    <p>Possible values: <code>fill</code>, <code>no_scale</code>, <code>fit</code>.</p>
                                    <p>Default value: <code>fit</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <div class="yfm-clipboard">
                            <pre><code class="hljs json">
                                {`{
                                    ...
                                    player_settings_payload: "object",
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-405" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-405" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-405.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-text" target="_self"
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-absolute-edge-insets"
                                target="_self" class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">absolute-edge-insets</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
