    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-separator" aria-current="page">separator</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-separator</span></h1>
                <div class="dc-doc-page__page-contributors"></div>
                <div class="dc-doc-page__content-mini-toc yfm">
                    <ul>
                        <li><a href="en/concepts/divs/2/div-separator#parameters">Parameters</a>
                            <ul>
                                <li><a href="en/concepts/divs/2/div-separator#delimiter_style">delimiter_style</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>A separating line between elements.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-separator#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>separator</code>.</p>
                            ...
                            <tr>
                                <td><code>delimiter_style</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Separator display settings.</p>
                                    <p>The value has the type <code>delimiter_style</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <h3 id="delimiter_style"><a href="en/concepts/divs/2/div-separator#delimiter_style" class="yfm-anchor"
                            aria-hidden="true"></a>delimiter_style</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Separator color. To prevent the separator from being displayed, set transparency in
                                        the alpha channel. For example, <code>#00FFFFFF</code>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Separator orientation:</p>
                                    <li><code>vertical</code> — vertical;</li>
                                    <li><code>horizontal</code> — horizontal.</li>&lt;<p></p>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-366" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-366" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-366.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/select')} target="_self"
                                ...
                                <div class="dc-nav-toc-panel__control-name">select</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/slider')}
                                class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">slider</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
