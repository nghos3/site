    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-wrap-content-size" aria-current="page">wrap-content-size</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-wrap-content-size</span></h1>
                <div class="dc-doc-page__page-contributors"></div>
                <div class="dc-doc-page__content-mini-toc yfm">
                    <ul>
                        <li><a href="en/concepts/divs/2/div-wrap-content-size#parameters">Parameters</a>
                            <ul>
                                <li><a href="en/concepts/divs/2/div-wrap-content-size#constraint_size">constraint_size</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>The size of an element adjusts to its contents.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-wrap-content-size#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>wrap_content</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The final size mustn't exceed the parent one. On iOS and in a default browser
                                        <code>false</code>. On Android always <code>true</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Maximum size of an element.</p>
                                    <p>The value has the type <code>constraint_size</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Minimum size of an element.</p>
                                    <p>The value has the type <code>constraint_size</code>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <h3 id="constraint_size"><a href="en/concepts/divs/2/div-wrap-content-size#constraint_size"
                            class="yfm-anchor" aria-hidden="true"></a>constraint_size</h3>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Default value: <code>dp</code>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-match-parent-size"
                                ...
                                <div class="dc-nav-toc-panel__control-name">match-parent-size</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-stroke" target="_self"
                                class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">stroke</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
