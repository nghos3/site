          ...
          <ol class="dc-breadcrumbs__items">
            ...
            <li class="dc-breadcrumbs__item">
              <span
                ...
                href="en/concepts/divs/2/div-aspect"
                aria-current="page"
              >
                aspect
              </span>
      ...
      <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
          ...
          <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
            <p>
              Fixed aspect ratio. The element's height is calculated based on
              the width, ignoring the
              <code>height</code> value.
            </p>
            <h2 id="parameters">
              <a
                href="en/concepts/divs/2/div-aspect#parameters"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              Parameters
                  ...
                  >
                    ...
                    >
                      ...
                      <animate
                        ...
                        to="hidden"
                        dur="1s"
                        begin="visibileAnimation-29.end+1"
                        fill="freeze"
                      ></animate>
                    </path>
                  </svg>
