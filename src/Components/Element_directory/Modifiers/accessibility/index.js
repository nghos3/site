            ...
            <ol class="dc-breadcrumbs__items">
              ...
              <li class="dc-breadcrumbs__item">
                <span
                  ...
                  href="en/concepts/divs/2/div-accessibility"
                  aria-current="page"
                  >accessibility</span
                >
              </li>
        ...
        <div class="dc-doc-page__main">
          <main class="dc-doc-page__content">
            ...
            <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
              ...
              <h2 id="parameters">
                <a
                  href="en/concepts/divs/2/div-accessibility#parameters"
                  class="yfm-anchor"
                  aria-hidden="true"
                ></a
                >Parameters
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <p>
                        ...
                        Hints is enabled in the VoiceOver settings on iOS, a tooltip
                        is played after <code>description</code>.
                      </p>
                  ...
                  <tr>
                    ...
                    <td>
                      <p><strong>string</strong></p>
                      <p>
                        The way the accessibility tree is organized. In the
                        <code>merge</code> mode the accessibility service perceives an
                        element together with a subtree as a whole. In the
                        <code>exclude</code> mode an element together with a subtree
                        isn't available for accessibility.
                      </p>
                      <p>
                        Possible values: <code>default</code>, <code>merge</code>,
                        <code>exclude</code>.
                      </p>
                  ...
                  <tr>
                    <td><code>mute_after_action</code></td>
                    <td>
                  ...
                  <tr>
                    <td><code>state_description</code></td>
                    <td>
                      <p><strong>string</strong></p>
                      <p>
                        Description of the current state of an element. For example,
                        in the description you can specify a selected date for a date
                        selection element and an on/off state for a switch.
                      </p>
                      <p>Available platforms: Android, iOS.</p>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      ...
                      <p>
                        ...
                        accessibility service. For example, the
                        <code>list</code> element is used to group list elements into
                        one element.
                      </p>
                      <p>
                        Possible values: <code>none</code>, <code>button</code>,
                        <code>image</code>, <code>text</code>, <code>edit_text</code>,
                        <code>header</code>, <code>tab_bar</code>, <code>list</code>,
                        <code>select</code>, <code>auto</code>.
                      </p>
  ...
  type: "string"
                    ...
                    >
                      ...
                      >
                        ...
                        <animate
                          ...
                          to="hidden"
                          dur="1s"
                          begin="visibileAnimation-69.end+1"
                          fill="freeze"
                        ></animate>
                      </path>
                    </svg>
            ...
            <div class="dc-doc-page__feedback">
              <div class="dc-feedback__container dc-feedback__container_view_wide">
                <div
                  class="dc-feedback__container-col dc-feedback__container-col_view_wide"
                >
                        ...
                        ><span class="g-button__icon-inner"
                          ...
                          >
                            <path
                              ...
                              clip-rule="evenodd"
                            ></path></svg></span></span
                      ><span class="g-button__text">Yes</span></button
                    ><button
                      class="g-button g-button_view_normal g-button_size_m g-button_pin_round-round dc-feedback__control dc-feedback__control_view_wide"
                      type="button"
                    >
