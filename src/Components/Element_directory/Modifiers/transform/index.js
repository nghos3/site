    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-transform" aria-current="page">transform</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-transform</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Transformation of the element.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-transform#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>X coordinate of the rotation axis.</p>
                                    <p>The value has the type <code>div-pivot</code>.</p>
                                    <p>Default value: {`<code>{"type": "pivot-percentage","value":50}</code>.`}</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li><a href="en/concepts/divs/2/div-pivot-fixed#div-pivot-fixed">div-pivot-fixed</a>
                                    </li>
                                    <li><a
                                            href="en/concepts/divs/2/div-pivot-percentage#div-pivot-percentage">div-pivot-percentage</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Y coordinate of the rotation axis.</p>
                                    <p>The value has the type <code>div-pivot</code>.</p>
                                    <p>Default value: {`<code>{"type": "pivot-percentage","value":50}</code>.`}</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Degrees of the element rotation. Positive values used for clockwise rotation.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-tooltip" target="_self"
                                ...
                                <div class="dc-nav-toc-panel__control-name">tooltip</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-appearance-transition"
                                target="_self" class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">appearance-transition</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
