          ...
          <ol class="dc-breadcrumbs__items">
            ...
            <li class="dc-breadcrumbs__item">
              <span
                ...
                href="en/concepts/divs/2/div-tabs"
                aria-current="page"
              >
                tabs
              </span>
      ...
      <div class="dc-doc-page__main">
        <main class="dc-doc-page__content">
          ...
          <div class="dc-doc-page__content-mini-toc yfm">
            <ul>
              <li>
                <a href="en/concepts/divs/2/div-tabs#parameters">Parameters</a>
                <ul>
                  <li>
                    <a href="en/concepts/divs/2/div-tabs#tab_title_style">
                      tab_title_style
                    </a>
                  </li>
                  <li>
                    <a href="en/concepts/divs/2/div-tabs#tab_title_delimiter">
                      tab_title_delimiter
                    </a>
                  </li>
                  <li>
                    <a href="en/concepts/divs/2/div-tabs#item">item</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
            <p>
              Tabs. Height of the first tab is determined by its contents, and
              height of the remaining{" "}
              <a href="en/concepts/location#tabs">depends on the platform</a>.
            </p>
            <h2 id="parameters">
              <a
                href="en/concepts/divs/2/div-tabs#parameters"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              Parameters
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <li>
                      <code>div-action://set_current_item?id=&amp;item=</code> —
                      set the current tab with an ordinal number{" "}
                      <code>item</code> inside an element, with the specified
                      <code>id</code>;
                    </li>
                    <li>
                      <code>
                        div-action://set_next_item?id=[&amp;overflow=
                        {`clamp|ring`}]
                      </code>{" "}
                      — go to the next tab inside an element, with the specified{" "}
                      <code>id</code>;
                    </li>
                    <li>
                      <code>
                        div-action://set_previous_item?id=[&amp;overflow=
                        {`clamp|ring`}]
                      </code>{" "}
                      — go to the previous tab inside an element, with the
                      specified <code>id</code>.
                    </li>
                    <p></p>
                    <p>
                      The optional <code>overflow</code> parameter is used to
                      set navigation when the first or last element is reached:
                    </p>
                    <li>
                      <code>clamp</code> — transition will stop at the border
                      element;
                    </li>
                    <li>
                      <code>ring</code> — go to the beginning or end, depending
                      on the current element.
                    </li>
                    <p></p>
                    <p>
                      By default, <code>clamp</code>.
                    </p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>Required parameter.</p>
                    <p>
                      The value must always be <code>tabs</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    <code>has_separator</code>
                  </td>
                  <td>
                    <p>
                      <strong>bool_int</strong>
                    </p>
                    <p>A separating line between tabs and contents.</p>
                    <p>
                      Default value: <code>false</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                ...
                <tr>
                  <td>
                    <code>restrict_parent_scroll</code>
                  </td>
                  <td>
                    <p>
                      <strong>bool_int</strong>
                    ...
                    <p>
                      ...
                      scroll gesture to the parent element.
                    </p>
                    <p>
                      Default value: <code>false</code>.
                    </p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Default value: <code>#14000000</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Default value:{" "}
                      <code>{`{"left": 12,"right": 12,"top": 0,"bottom": 0}`}</code>
                      .
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                ...
                <tr>
                  <td>
                    <code>switch_tabs_by_content_swipe_enabled</code>
                  </td>
                  <td>
                    <p>
                      <strong>bool_int</strong>
                    </p>
                    <p>Switching tabs by scrolling through the contents.</p>
                    <p>
                ...
                <tr>
                  <td>
                    <code>tab_title_delimiter</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                    </p>
                    <p>Style of delimiters between tab titles.</p>
                    <p>
                      The value has the type <code>tab_title_delimiter</code>.
                    </p>
                ...
                <tr>
                  <td>
                    <code>tab_title_style</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                    </p>
                    <p>Design style of tab titles.</p>
                    <p>
                      The value has the type <code>tab_title_style</code>.
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <code>title_paddings</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                    </p>
                    <p>Indents in the tab name.</p>
                    <p>
                      The value has the type <code>div-edge-insets</code>.
                    </p>
                    <p>
                      Default value:{" "}
                      <code>{`{"left": 12,"right": 12,"top": 0,"bottom": 8}`}</code>
                      .
                    </p>
                    <p>Available platforms: Android, iOS, web.</p>
                  </td>
            ...
            <h3 id="tab_title_style">
              <a
                href="en/concepts/divs/2/div-tabs#tab_title_style"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              tab_title_style
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>
                    <code>active_background_color</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                    </p>
                    <p>Background color of the active tab title.</p>
                    <p>
                      Valid formats: <code>#RGB</code>, <code>#ARGB</code>,{" "}
                      <code>#RRGGBB</code>,<code>#AARRGGBB</code>.
                    </p>
                    <p>
                      Default value: <code>#FFFFDC60</code>.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <code>active_font_weight</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                    </p>
                    <p>Active tab title style.</p>
                    <p>
                ...
                <tr>
                  <td>
                    <code>active_text_color</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                    </p>
                    <p>Color of the active tab title text.</p>
                    <p>
                      Valid formats: <code>#RGB</code>, <code>#ARGB</code>,{" "}
                      <code>#RRGGBB</code>,<code>#AARRGGBB</code>.
                    </p>
                    <p>
                      Default value: <code>#CC000000</code>.
                    </p>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <p>Duration of active title change animation.</p>
                    <p>
                      Restriction for the value <code>x</code>:{" "}
                      <code>x &gt;= 0</code>.
                    </p>
                ...
                <tr>
                  <td>
                    <code>animation_type</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                    </p>
                    <p>Active title change animation.</p>
                    <p>
                      Possible values: <code>slide</code>, <code>fade</code>,{" "}
                      <code>none</code>.
                    </p>
                    <p>
                      Default value: <code>slide</code>.
                    </p>
                    <p>Available platforms: Android, iOS.</p>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      specified, the rounding is maximum (half of the smallest
                      size). Not used if the <code>corners_radius</code>
                      parameter is set.
                    </p>
                    <p>
                      Restriction for the value <code>x</code>:{" "}
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      The value has the type <code>div-corners-radius</code>.
                    </p>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>Units of title font size measurement.</p>
                    <p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      Style. Use <code>active_font_weight</code> and{" "}
                      <code>inactive_font_weight</code>
                      instead.
                    </p>
                    <p>
                      Possible values: <code>light</code>, <code>medium</code>,{" "}
                ...
                <tr>
                  <td>
                    <code>inactive_background_color</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                    </p>
                    <p>Background color of the inactive tab title.</p>
                    <p>
                      Valid formats: <code>#RGB</code>, <code>#ARGB</code>,{" "}
                      <code>#RRGGBB</code>,<code>#AARRGGBB</code>.
                    </p>
                ...
                <tr>
                  <td>
                    <code>inactive_text_color</code>
                  </td>
                  <td>
                    <p>
                      <strong>string</strong>
                    </p>
                    <p>Color of the inactive tab title text.</p>
                    <p>
                      Valid formats: <code>#RGB</code>, <code>#ARGB</code>,{" "}
                      <code>#RRGGBB</code>,<code>#AARRGGBB</code>.
                    </p>
                    <p>
                      Default value: <code>#80000000</code>.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <code>item_spacing</code>
                  </td>
                  <td>
                    <p>
                      <strong>int</strong>
                    </p>
                    <p>Spacing between neighbouring tab titles.</p>
                    <p>
                      Restriction for the value <code>x</code>:{" "}
                      <code>x &gt;= 0</code>.
                    </p>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>Spacing between title characters.</p>
                    <p>
                      Default value: <code>0</code>.
                    </p>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>Indents around the tab title.</p>
                    <p>
                      The value has the type <code>div-edge-insets</code>.
                    </p>
                    <p>
                      Default value:{" "}
                      <code>{`{"left": 8,"right": 8,"top": 6,"bottom": 6}`}</code>
                      .
                    </p>
                  </td>
                </tr>
            ...
            <h3 id="tab_title_delimiter">
              <a
                href="en/concepts/divs/2/div-tabs#tab_title_delimiter"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              tab_title_delimiter
            ...
            <h3 id="item">
              <a
                href="en/concepts/divs/2/div-tabs#item"
                class="yfm-anchor"
                aria-hidden="true"
              ></a>
              item
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <code>title_click_action</code>
                  </td>
                  <td>
                    <p>
                      <strong>object</strong>
                    </p>
                    <p>Action when clicking on the active tab title.</p>
                    <p>
                ...
                <button class="yfm-clipboard-button" aria-label="Copy">
                  ...
                  >
                    ...
                    >
                      ...
                      ></animate>
                      <animate
                        id="hideAnimation-616"
                        attributeName="visibility"
                        from="visible"
                        to="hidden"
                        dur="1s"
                        begin="visibileAnimation-616.end+1"
                        fill="freeze"
                      ></animate>
                    </path>
                  </svg>
          ...
          <div class="dc-nav-toc-panel__content">
            <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
              ...
              <div class="dc-nav-toc-panel__control-text">
                <a
                  onClick={() =>
                    navigate("/element-directory/basic-elements/state")
                  }
                ...
                >
                  ...
                  <div class="dc-nav-toc-panel__control-name">state</div>
                </a>
              </div>
            </div>
            <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
              ...
              <div class="dc-nav-toc-panel__control-text">
                <a
                  onClick={() =>
                    navigate("/element-directory/basic-elements/text")
                  }
                  class="dc-nav-toc-panel__link"
                  data-router-shallow="true"
                >
                  <div class="dc-nav-toc-panel__control-name">text</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
