    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-gallery" aria-current="page">gallery</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-gallery</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Gallery. It contains a horizontal or vertical set of cards that can be scrolled.</p>
                    <h2 id="parameters"><a href="en/concepts/divs/2/div-gallery#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>gallery</code>.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Number of columns for block layout.</p>
                            ...
                            <tr>
                                <td><code>cross_content_alignment</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Aligning elements in the direction perpendicular to the scroll direction. In
                                        horizontal galleries:</p>
                                    <li><code>start</code> — alignment to the top of the card;</li>
                                    <li><code>center</code> — to the center;</li>
                                    <li><code>end</code> — to the bottom.</li>
                                    <p></p>
                                    <p>In vertical galleries:</p>
                                    <li><code>start</code> — alignment to the left of the card;</li>
                                    <li><code>center</code> — to the center;</li>
                                    <li><code>end</code> — to the right.</li>
                                    <p></p>
                                    <p>Possible values: <code>start</code>, <code>center</code>, <code>end</code>.</p>
                                    <p>Default value: <code>start</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>cross_spacing</code></td>
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Spacing between elements across the scroll axis. By default, the value set to
                                        <code>item_spacing</code>.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Ordinal number of the gallery element to be scrolled to by default. For
                                        <code>scroll_mode</code>:</p>
                                    <li><code>default</code> — the scroll position is set to the beginning of the element,
                                        without taking into account <code>item_spacing</code>;</li>
                                    <li><code>paging</code> — the scroll position is set to the center of the element.</li>
                                    <p></p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>Gallery elements. Scrolling to elements can be implemented using:</p>
                                    <li><code>div-action://set_current_item?id=&amp;item=</code> — scrolling to the element
                                        with an ordinal number <code>item</code> inside an element, with the specified
                                        <code>id</code>;</li>
                                    <li><code>div-action://set_next_item?id=[&amp;overflow={`clamp|ring`}]</code> — scrolling
                                        to the next element inside an element, with the specified <code>id</code>;</li>
                                    <li><code>div-action://set_previous_item?id=[&amp;overflow={`clamp|ring`}]</code> —
                                        scrolling to the previous element inside an element, with the specified
                                        <code>id</code>.</li>
                                    <p></p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>If the parameter is enabled, the gallery won't transmit the scroll gesture to the
                                        parent element.</p>
                            ...
                            <tr>
                                <td><code>scroll_mode</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Scroll type: <code>default</code> — continuous, <code>paging</code> — page-by-page.
                                    </p>
                                    <p>Possible values: <code>paging</code>, <code>default</code>.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Scrollbar behavior. Hidden by default. When choosing a gallery size, keep in mind
                                        that the scrollbar may have a different height and width depending on the platform
                                        and user settings. </p>
                                    <li><code>none</code>&nbsp;— the scrollbar is hidden.</li>
                                    <li><code>auto</code>&nbsp;— the scrollbar is shown if there isn't enough space and it
                                        needs to be displayed on the current platform.</li>
                                    <p></p>
                                    <p>Possible values: <code>none</code>, <code>auto</code>.</p>
                                    <p>Default value: <code>none</code>.</p>
                                    <p>Available platforms: web, Android.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-373" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-373" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-373.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
            ...
            <div class="dc-nav-toc-panel dc-doc-page__toc-nav-panel">
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/data')} target="_self"
                                ...
                                <div class="dc-nav-toc-panel__control-name">data</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a onClick={()=>navigate('/element-directory/basic-elements/gif-image')}
                                target="_self" class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">gif-image</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
