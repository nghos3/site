        ...
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item">
                        <a class="dc-breadcrumbs__text dc-breadcrumbs__text_link"
                            href="en/concepts/divs/2/div-indicator-item-placement">indicator-item-placement</a>
                    </li>
                    <li class="dc-breadcrumbs__item">
                        <span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-default-indicator-item-placement"
                            aria-current="page">default-indicator-item-placement</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title">
                    <span>div-default-indicator-item-placement</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    ...
                    <h2 id="parameters">
                        <a href="en/concepts/divs/2/div-default-indicator-item-placement#parameters" class="yfm-anchor"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>The value must always be <code>default</code>.</p>
                ...
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text">
                            <a href="en/concepts/divs/2/div-indicator-item-placement" target="_self"
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        ...
                        <div class="dc-nav-toc-panel__control-text">
                            <a href="en/concepts/divs/2/div-stretch-indicator-item-placement" target="_self"
                                class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">
                                    stretch-indicator-item-placement
                                </div>
