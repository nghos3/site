    ...
    return (<div class="dc-doc-layout__center">
            ...
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item"><span class="dc-breadcrumbs__text"
                            href="en/concepts/divs/2/div-corners-radius" aria-current="page">corners-radius</span></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                <h1 class="dc-doc-page-title dc-doc-page__title"><span>div-corners-radius</span><button
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Sets corner rounding.</p>
                    <h2 id="parameters">
                        <a href="en/concepts/divs/2/div-corners-radius#parameters" className="yfm-anchor"
                            aria-hidden="true"/>Parameters</h2>
                    <table>
                        <thead>
                            <tr>
                                <th>Parameters</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Rounding radius of a lower left corner. If not specified, then
                                        <code>corner_radius</code> is used.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Rounding radius of a lower right corner. If not specified, then
                                        <code>corner_radius</code> is used.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Rounding radius of an upper left corner. If not specified, then
                                        <code>corner_radius</code> is used.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>Rounding radius of an upper right corner. If not specified, then
                                        <code>corner_radius</code> is used.</p>
                                    <p>Restriction for the value <code>x</code>: <code>x &gt;= 0</code>.</p>
                                </td>
                            </tr>
                ...
                <div class="dc-nav-toc-panel__content">
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-border" target="_self"
                                ...
                                <div class="dc-nav-toc-panel__control-name">border</div>
                            </a></div>
                    </div>
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_right">
                        <div class="dc-nav-toc-panel__control-hint">Next</div>
                        <div class="dc-nav-toc-panel__control-text"><a href="en/concepts/divs/2/div-count" target="_self"
                                class="dc-nav-toc-panel__link" data-router-shallow="true">
                                <div class="dc-nav-toc-panel__control-name">count</div><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 16 16">
                                    <path fill="currentColor" fill-rule="evenodd"
