        ...
        <div class="dc-doc-page__breadcrumbs">
            <nav class="dc-breadcrumbs" aria-label="Breadcrumbs">
                <ol class="dc-breadcrumbs__items">
                    ...
                    <li class="dc-breadcrumbs__item">
                        <span class="dc-breadcrumbs__text" href="en/concepts/divs/2/div-input"
                            aria-current="page">input</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="dc-doc-page__main">
            <main class="dc-doc-page__content">
                ...
                <div class="dc-doc-page__content-mini-toc yfm">
                    <ul>
                        <li>
                            <a href="en/concepts/divs/2/div-input#parameters">Parameters</a>
                            <ul>
                                <li>
                                    <a href="en/concepts/divs/2/div-input#native_interface">native_interface</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="dc-doc-page__body dc-doc-page__body_text-size_m yfm">
                    <p>Text input element.</p>
                    <h2 id="parameters">
                        <a href="en/concepts/divs/2/div-input#parameters" class="yfm-anchor"
                            aria-hidden="true"></a>Parameters
                    </h2>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td><code>text_variable</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Required parameter.</p>
                                    <p>Name of text storage variable.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Required parameter.</p>
                                    <p>The value must always be <code>input</code>.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>
                                        ...
                                        completely transparent, <code>1</code> — opaque.
                                    </p>
                                    <p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>
                                        Declaration of animators that can be used to change the value
                            ...
                            <tr>
                                <td><code>autocapitalization</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Automatic text capitalization type.</p>
                                    <p>
                                        Possible values: <code>auto</code>, <code>none</code>,
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>
                                        ...
                                        <a href="en/concepts/divs/2/div-grid">grid</a> element.
                                    </p>
                                    <p>
                                        Restriction for the value <code>x</code>:
                                        <code>x &gt;= 0</code>.
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>
                                        Extensions for additional processing of an element. The list
                                        of extensions is given in
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>
                                        Filtering that prevents the entry of text that does not meet
                                    ...
                                    <li>
                                        <a
                                            href="en/concepts/divs/2/div-input-filter-regex#div-input-filter-regex">div-input-filter-regex</a>
                                    </li>
                                    <li>
                                        <a
                                            href="en/concepts/divs/2/div-input-filter-expression#div-input-filter-expression">div-input-filter-expression</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>
                                        Element height. For Android: if there is text in this or in a
                                        child element, specify height in <code>sp</code> to scale the
                                        element together with the text. To learn more about units of
                                        size measurement, see
                                    ...
                                    <p>List of possible values:</p>
                                    <li>
                                        <a href="en/concepts/divs/2/div-fixed-size#div-fixed-size">div-fixed-size</a>
                                    </li>
                                    <li>
                                        <a
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>
                                        Text highlight color. If the value isn't set, the color set in
                                        the client will be used instead.
                                    </p>
                                    <p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Default value: <code>#73000000</code>.</p>
                                </td>
                            </tr>
                            <tr>
                                <td><code>hint_text</code></td>
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>Tooltip text.</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>string</strong></p>
                                    <p>
                                        Element ID. It must be unique within the root element. It is
                                        used as <code>accessibilityIdentifier</code> on iOS.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Indicates if the text editing is enabled.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>Keyboard type.</p>
                                    <p>
                                        Possible values: <code>single_line_text</code>,
                                        <code>multi_line_text</code>, <code>phone</code>,
                                        <code>number</code>, <code>email</code>, <code>uri</code>,
                                        <code>password</code>.
                                    </p>
                                    <p>Default value: <code>multi_line_text</code>.</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Mask for entering text based on the specified template.</p>
                                    <p>The value has the type <code>div-input-mask</code>.</p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li>
                                        <a
                                            href="en/concepts/divs/2/div-fixed-length-input-mask#div-fixed-length-input-mask">div-fixed-length-input-mask</a>
                                    </li>
                                    <li>
                                        <a
                                            href="en/concepts/divs/2/div-currency-input-mask#div-currency-input-mask">div-currency-input-mask</a>
                                    </li>
                                    <li>
                                        <a
                                            href="en/concepts/divs/2/div-phone-input-mask#div-phone-input-mask">div-phone-input-mask</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td><code>max_visible_lines</code></td>
                                <td>
                                    <p><strong>int</strong></p>
                                    <p>
                            ...
                            <tr>
                                <td><code>native_interface</code></td>
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>Text input line used in the native interface.</p>
                                    <p>The value has the type <code>native_interface</code>.</p>
                            ...
                            <tr>
                                <td><code>select_all_on_focus</code></td>
                                <td>
                                    <p><strong>bool_int</strong></p>
                                    <p>Highlighting input text when focused.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>
                                        List of <a href="en/concepts/divs/2/div-action">actions</a> to
                                        be executed when selecting an element in
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>
                                        Applies the passed transformation to the element. Content that
                                        doesn't fit into the original view area is cut off.
                                    </p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>
                                        Change animation. It is played when the position or size of an
                                        element changes in the new layout.
                                    </p>
                                    <p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>object</strong></p>
                                    <p>
                                        Appearance animation. It is played when an element with a new
                                        ID appears. To learn more about the concept of transitions,
                                        see
                                        <a href="en/concepts/interaction#animation/transition-animation">Animated
                                            transitions</a>.
                                    </p>
                                    <p>
                                        The value has the type <code>div-appearance-transition</code>.
                                    </p>
                                    <p>Available platforms: Android, iOS, web.</p>
                                    <p>List of possible values:</p>
                                    <li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>
                                        Validator that checks that the field value meets the specified
                                        conditions.
                                    </p>
                                    <p>Available platforms: Android, iOS.</p>
                                    <p>List of possible values:</p>
                                    <li>
                                        <a
                                            href="en/concepts/divs/2/div-input-validator-regex#div-input-validator-regex">div-input-validator-regex</a>
                                    </li>
                                    <li>
                                        <a
                                            href="en/concepts/divs/2/div-input-validator-expression#div-input-validator-expression">div-input-validator-expression</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><strong>array</strong></p>
                                    <p>
                                        Definition of variables that can be used within this element.
                                        These variables, defined in the array, can only be used inside
                                        this element and its children.
                                    </p>
                                    <p>Available platforms: iOS, web, Android.</p>
                                    <p>List of possible values:</p>
                                    <li>
                                        <a href="en/concepts/divs/2/string_variable#string_variable">string_variable</a>
                                    </li>
                                    <li>
                                        <a href="en/concepts/divs/2/number_variable#number_variable">number_variable</a>
                                    </li>
                                    <li>
                                        <a href="en/concepts/divs/2/integer_variable#integer_variable">integer_variable</a>
                                    </li>
                                    <li>
                                        <a href="en/concepts/divs/2/boolean_variable#boolean_variable">boolean_variable</a>
                                    </li>
                                    <li>
                                        <a href="en/concepts/divs/2/color_variable#color_variable">color_variable</a>
                                    </li>
                                    <li>
                                        <a href="en/concepts/divs/2/url_variable#url_variable">url_variable</a>
                                    </li>
                                    <li>
                                        <a href="en/concepts/divs/2/dict_variable#dict_variable">dict_variable</a>
                                    </li>
                                    <li>
                                        <a href="en/concepts/divs/2/array_variable#array_variable">array_variable</a>
                                    </li>
                                    <p></p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>
                                        Possible values: <code>visible</code>, <code>invisible</code>,
                                        <code>gone</code>.
                                    </p>
                    ...
                    <h3 id="native_interface">
                        <a href="en/concepts/divs/2/div-input#native_interface" class="yfm-anchor"
                            aria-hidden="true"></a>native_interface
                    </h3>
                    <table>
                        <thead>
                            <tr>
                            ...
                            <button class="yfm-clipboard-button" aria-label="Copy">
                                <svg width="16" height="16" viewBox="0 0 24 24" class="yfm-clipboard-icon"
                                    ...
                                    <path stroke="currentColor" fill="transparent" stroke-width="1.5" d="M9.5 13l3 3l5 -5"
                                        visibility="hidden">
                                        <animate id="visibileAnimation-502" attributeName="visibility" from="hidden"
                                            to="visible" dur="0.2s" fill="freeze" begin=""></animate>
                                        <animate id="hideAnimation-502" attributeName="visibility" from="visible"
                                            to="hidden" dur="1s" begin="visibileAnimation-502.end+1" fill="freeze">
                                        </animate>
                                    </path>
                                </svg>
                            </button>
                    ...
                    <div class="dc-nav-toc-panel__control dc-nav-toc-panel__control_left">
                        ...
                        <div class="dc-nav-toc-panel__control-text">
                            <a onClick={()=>navigate('/element-directory/basic-elements/indicator')} class="dc-nav-toc-panel__link"
                                ...
                                <div class="dc-nav-toc-panel__control-name">indicator</div>
                            </a>
                        </div>
                    </div>
